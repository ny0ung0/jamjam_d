...
public interface CompanyDao {
	Company company = new Company();
	 ...
	 @Update("UPDATE user SET company_name=#{company_name},registration_number=#{registration_number},company_type=#{company_type},representative_name=#{representative_name},address=#{address},tel=#{tel}  "
		 		+ "WHERE email =#{email} ")
	 public int insertCompany(Company company);
	 
	 @Select("select * from user where company_id = #{company_id}")
	 ...
	 @Delete("delete from user where company_id = #{company_id}")
